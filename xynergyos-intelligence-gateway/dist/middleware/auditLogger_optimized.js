...
class BatchProcessor {
    ...
    flushTimer = null;
    processFn;
    constructor(batchSize = 100, flushInterval = 5000, processFn) {
...
function determineSeverity(statusCode, error) {
...
const batchProcessor = new BatchProcessor(50, // batch size
...
const auditCircuitBreaker = new opossum_1.default(async (event) => {
...
function auditLogger() {
    return async (req, res, next) => {
        ...
        res.on('finish', async () => {
            ...
            // Build audit event
            const auditEvent = {
                log_id: `log_${(0, uuid_1.v4)().substring(0, 8)}`,
...
function securityAlert(action, severity = 'WARNING') {
    return async (req, res, next) => {
        const user = req.user;
...
function complianceTracker(complianceType) {
    return async (req, res, next) => {
        const user = req.user;
        const userId = user?.uid || 'anonymous';
        const requestId = req.requestId || (0, uuid_1.v4)();
...
//# sourceMappingURL=auditLogger_optimized.js.map