 ...
 */
router.get('/monitoring/cost', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    logger_1.logger.info('Fetching cost metrics', { userId: req.user.uid });
 ...
 */
router.get('/monitoring/circuit-breakers', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    logger_1.logger.info('Fetching circuit breaker metrics', { userId: req.user.uid });
    ...
    const metrics = {
        ...
        summary: {
            ...
            half_open: Object.values(circuitBreakers).filter((cb) => cb.state === 'half-open').length,
 ...
 */
router.get('/monitoring/resources', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    logger_1.logger.info('Fetching resource metrics', { userId: req.user.uid });
 ...
 */
router.get('/monitoring/health', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    logger_1.logger.info('Fetching system health', { userId: req.user.uid });
    const cache = (0, cacheService_1.getCacheService)();
    const registry = (0, circuitBreaker_1.getCircuitBreakerRegistry)();
    const healthStatus = {
        timestamp: new Date().toISOString(),
...
router.get('/users', (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    logger_1.logger.info('Fetching users list', {
        userId: req.user.uid,
        limit,
        offset,
        role,
 ...
 */
router.patch('/users/:userId', (0, errorHandler_1.asyncHandler)(async (req, res) => {
